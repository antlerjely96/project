...
{{--                                    {{ dd($attendanceStatusDetail) }}--}}
                                    @if($student->id == $student_id)
                                        ...
                                        @endforeach
                                    @endif
{{--                                    @if($student->id == $attendanceStatusDetail->student_id)--}}
{{--                                        <td @click="$wire.editStatus('{{$attendanceStatusDetail->attendance_date}}', {{$attendanceStatusDetail->student_id}})" class="hover:bg-amber-200">--}}
{{--                                            @if($attendanceStatusDetail->attendance_status == 'attended')--}}
{{--                                                <span> - </span>--}}
{{--                                            @elseif($attendanceStatusDetail->attendance_status == 'absences_without_permission')--}}
{{--                                                <span> N </span>--}}
{{--                                            @elseif($attendanceStatusDetail->attendance_status == 'late')--}}
{{--                                                <span> L </span>--}}
{{--                                            @elseif($attendanceStatusDetail->attendance_status == 'absences_with_permission')--}}
{{--                                                <span> P </span>--}}
{{--                                            @endif--}}
{{--                                        </td>--}}
{{--                                    @endif--}}
